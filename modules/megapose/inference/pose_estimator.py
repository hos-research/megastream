...
# MegaPose
from megapose.inference.utils import filter_detections, add_instance_id
...
from megapose.utils.timer import Timer, CudaTimer, SimpleTimer
from megapose.inference.types import assert_detections_valid
...
class PoseEstimator(torch.nn.Module):
    ...
    def forward_coarse_model(
        ...
        assert_detections_valid(detections)
    ...
    def release(self) -> None:
        self.coarse_model.stop()
        self.refiner_model.stop()
