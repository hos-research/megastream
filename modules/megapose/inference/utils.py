...
from megapose.lib3d.rigid_mesh_database import MeshDataBase, BatchedMeshes
...
from megapose.config.detector_models_cfg import (
    check_update_config as check_update_config_detector,
)
from megapose.config.detector_models_cfg import create_model_detector
from megapose.config.pose_models_cfg import (
    check_update_config as check_update_config_pose,
)
from megapose.config.pose_models_cfg import create_model_pose
from megapose.config.training_config import TrainingConfig
...
def load_detector(model_dir: str) -> torch.nn.Module:
...
def load_pose_models(
    ...
    logger.info("Creating MeshDatabase")
    mesh_db = MeshDataBase.from_object_ds(object_dataset)
    logger.info("Done creating MeshDatabase")
